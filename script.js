...
formulario.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        let mensaje = 'send?phone=' + telefono + '&text= ' + codigo + '*%0AMovil :*' + vehiculo + '%0ACargos : ' + todos + '%0AConos : ' + conos + '%0ANovedades : ' + novedades +'%0ALugar : ' + lugar + '%0AHora : ' + hora + '%0ABoucher : ' + boucher + '%0AEstanque : ' + estanque + '%0AObservaciones : ' + observaciones + ''
